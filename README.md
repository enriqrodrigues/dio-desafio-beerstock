<h3>Desafio de projeto elaborado pelo Rodrigo Peleias para demosntrar o desenvolvimento de testes em API REST.
Fiz uma pequena alteração nas classes "BeerService" e "BeerController" para adicionar o método de decremento.</h2>
